        ...
        <div className="grid lg:grid-cols-2 gap-12 ">
          ...
          <div className="space-y-6">
            <p className="text-lg md:text-xl text-foreground/80 leading-relaxed">
              World leaders commit to unprecedented carbon reduction targets in landmark deal that could reshape the
...
{news.map((item, idx) => (
  <Link href={`/news/${item.title}`} key={idx} className="flex relative rounded-lg overflow-hidden group ">
